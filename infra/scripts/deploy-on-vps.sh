...
echo "→ build api + web + license-server"
$COMPOSE build api web license-server
...
echo "→ recreate api + web + license-server"
$COMPOSE up -d --force-recreate api web license-server
