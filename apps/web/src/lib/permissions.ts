...
export const MODULE_SECTIONS: Record<ModuleKey, { href: string; label: string; count?: number }[]> = {
  sales: [
    ...
    { href: '/sales/commissions', label: 'العمولات' },
  ],
  pos: [
    { href: '/pos/shifts',     label: 'الورديات' },
    { href: '/pos/sale',       label: 'شاشة البيع' },
  ],
  inventory: [
    { href: '/inventory/products',     label: 'المنتجات' },
    { href: '/inventory/categories',   label: 'التصنيفات' },
    ...
    { href: '/inventory/intelligence', label: 'المخزون الذكي' },
  ],
  purchases: [
  ...
  finance: [
    ...
    { href: '/finance/chart-of-accounts', label: 'دليل الحسابات' },
    ...
    { href: '/finance/budgets',           label: 'الموازنات' },
    { href: '/finance/periods',           label: 'الفترات المحاسبية' },
    { href: '/finance/kpis',              label: 'مؤشرات الأداء' },
    { href: '/finance/account-mapping',   label: 'ربط الحسابات' },
  ],
  assets: [
