...
## عند فتح أي جلسة جديدة، نفّذ بالترتيب:

1. اقرأ هذا الملف (CLAUDE.md) كاملاً — أنت تقرأه الآن ✅
2. اقرأ `governance/SESSION_HANDOFF.md` — آخر موقف
3. اقرأ `governance/DECISIONS_LOG.md` — القرارات المقفلة
4. اقرأ `governance/MODULE_STATUS_BOARD.md` — حالة كل وحدة
5. اقرأ `governance/ARCHITECTURE.md` — القرارات التقنية
6. شوف `governance/OPEN_ISSUES.md` — مشاكل مفتوحة
7. راجع الملفات اللي اشتغلنا عليها آخر جلسة (من HANDOFF)
8. **اطبع ملخص**: "أنا فاهم إننا في [المرحلة]، آخر شي سويته [X]، اليوم لازم [Y]"

> ❌ إذا ما قرأت الملفات الستة — لا تبدأ أي عمل
> ❌ إذا ما فهمت الموقف الحالي — اسأل صاحب المشروع
> ❌ لا تظن إنك فاهم — تأكد من الملفات
